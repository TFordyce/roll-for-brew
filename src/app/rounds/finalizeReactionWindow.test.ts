...
describe("finalizeReactionWindow", () => {
  ...
  it("replaces a forced-reroll target's roll in place before calling applyLayerOutcome (issue #68)", async () => {
    const completedLayer: CompletedLayer = {
      layer: 0,
      rolls: [
        { playerId: "p1", value: 2, modifierSnapshot: 0, discardedValue: null, enteredByAdmin: false },
        { playerId: "p2", value: 12, modifierSnapshot: 0, discardedValue: null, enteredByAdmin: false },
      ],
    };
    const deps = fakeDeps({
    ...
    expect(deps.applyLayerOutcome).toHaveBeenCalledWith(supabase, "round-1", {
      layer: 0,
      rolls: [
        { playerId: "p1", value: 19, modifierSnapshot: 0, discardedValue: null, enteredByAdmin: false },
        { playerId: "p2", value: 12, modifierSnapshot: 0, discardedValue: null, enteredByAdmin: false },
      ],
    });
  });
  ...
  it("applies a forced reroll for every distinct target when multiple are active", async () => {
    const completedLayer: CompletedLayer = {
      ...
      rolls: [
        { playerId: "p1", value: 2, modifierSnapshot: 0, discardedValue: null, enteredByAdmin: false },
        { playerId: "p2", value: 3, modifierSnapshot: 0, discardedValue: null, enteredByAdmin: false },
        { playerId: "p3", value: 12, modifierSnapshot: 0, discardedValue: null, enteredByAdmin: false },
      ],
    };
    ...
    expect(deps.applyLayerOutcome).toHaveBeenCalledWith(supabase, "round-1", {
      layer: 1,
      rolls: [
        { playerId: "p1", value: 18, modifierSnapshot: 0, discardedValue: null, enteredByAdmin: false },
        { playerId: "p2", value: 4, modifierSnapshot: 0, discardedValue: null, enteredByAdmin: false },
        { playerId: "p3", value: 12, modifierSnapshot: 0, discardedValue: null, enteredByAdmin: false },
      ],
    });
  });
