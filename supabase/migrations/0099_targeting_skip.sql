...
-- effect row).
--
-- Migration numbering: 0097 is claimed by #320 (persistent advantage) and
-- 0098 by another in-flight slice; this takes 0099. The #303 integrate gate
-- re-verifies branch migration numbering against master's highest before the
-- master merge.
...
-- ---------------------------------------------------------------------------
-- 5. resolve_round(uuid) -- re-emitted from 0096's body with the issue #321
--    targeting-skip logic folded into Phase 4c and Phase 5 (see header).
--    Everything else is byte-identical to 0096.
-- ---------------------------------------------------------------------------
