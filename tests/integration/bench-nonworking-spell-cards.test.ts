...
describe.skipIf(!hasAnonTestEnv)("spell cards: non-working cards benched from the draw pool", () => {
  ...
  it("benches only cards from the documented non-working list", async () => {
    ...
    // Infusion (#319, migration 0095), the two fixed-roll cards — Steady
    // Hand, Sleeping Camomile (#317, migration 0094) — and Prophe-Tea
    // (persistent advantage, #320, migration 0097) — are since implemented
    // and un-benched, so 17.
